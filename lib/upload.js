...
const uploadRoot = process.env.PUBLIC_UPLOAD_ROOT || path.join(process.cwd(), "public", "uploads");
const privateUploadRoot = process.env.PRIVATE_UPLOAD_ROOT || path.join(process.cwd(), "storage", "uploads");
